...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 31, 2025 at 11:02 PM
...
INSERT INTO `drivers` (`id`, `user_id`, `license_photo_front`, `license_photo_back`, `vehicle_make`, `vehicle_model`, `vehicle_year`, `vehicle_plate`, `vehicle_color`, `vehicle_seats`, `vehicle_photo`, `services`, `packages`, `local_delivery_city`, `created_at`, `updated_at`) VALUES
(1, 3, 'drivers/1738187131_front.png', 'drivers/1738187131_back.png', 'Hic dolor et aliqua', 'Voluptatem eos ali', '2003', 'Earum voluptatem Fu', 'Quod sit assumenda l', '20', 'vehicles/1738187131_vehicle.webp', '\"[\\\"ride-sharing\\\", \\\"distance-delivery\\\"]\"', '\"[\\\"premium\\\",\\\"express\\\"]\"', 'Veniam iure quam la', '2025-01-29 21:45:31', '2025-01-29 21:45:31');
...
(3, 3, 'parcel_envelope', 2, 'Secret Envelope'),
(4, 3, 'mini_carton', 3, 'Plastic Bottles'),
(5, 1, 'parcel_envelope', 2, 'yess');
...
CREATE TABLE `users` (
  ...
  `role` enum('driver','local_delivery','business','partner_home','general_user','admin') NOT NULL,
...
INSERT INTO `users` (`id`, `name`, `email`, `phone`, `role`, `email_verified_at`, `password`, `terms_approved`, `remember_token`, `created_at`, `updated_at`) VALUES
(3, 'Urielle Gaines', 'fobuzimifi@mailinator.com', '+1 (339) 965-6367', 'driver', NULL, '$2y$12$mZpi3UFYuewbxQbNSv3hM.mgg4Hl4vMLc9iAeI2e8sKLSFw5J6dV6', 1, NULL, '2025-01-29 16:45:31', '2025-01-29 16:45:31'),
(4, 'User', 'user@yopmail.com', '+1 (811) 343-9574', 'general_user', NULL, '$2y$12$X0CAaPRLGyj.PYSgLwK5s.mkTLhCoRJBNhf1UNNs6aNOYTnnensRi', NULL, NULL, '2025-01-30 11:15:51', '2025-01-30 11:15:51');
...
CREATE TABLE `user_profiles` (
  ...
  `approved_terms` tinyint(1) DEFAULT NULL,
...
INSERT INTO `user_profiles` (`id`, `user_id`, `date_of_birth`, `address`, `approved_terms`, `profile_photo`, `created_at`, `updated_at`) VALUES
(1, 4, '2005-04-21', 'Pakistan', 1, 'profile_4.png', '2025-01-30 16:15:51', '2025-01-31 19:44:53');
...
(1, 4, 'North Nazimabad', 'Clifton', '2025-02-14', '7.91', 1, 'SUCCESS', '{\"id\":\"ch_3QnSEhBJNvSBJ4pq118pHogr\",\"object\":\"charge\",\"amount\":791,\"amount_captured\":791,\"amount_refunded\":0,\"application\":null,\"application_fee\":null,\"application_fee_amount\":null,\"balance_transaction\":\"txn_3QnSEhBJNvSBJ4pq1rVJGwi8\",\"billing_details\":{\"address\":{\"city\":null,\"country\":null,\"line1\":null,\"line2\":null,\"postal_code\":\"10001\",\"state\":null},\"email\":null,\"name\":null,\"phone\":null},\"calculated_statement_descriptor\":\"Stripe\",\"captured\":true,\"created\":1738360731,\"currency\":\"usd\",\"customer\":null,\"description\":\"Vicinity Delivery Fee\",\"destination\":null,\"dispute\":null,\"disputed\":false,\"failure_balance_transaction\":null,\"failure_code\":null,\"failure_message\":null,\"fraud_details\":[],\"invoice\":null,\"livemode\":false,\"metadata\":{\"delivery_id\":\"1\",\"user_id\":\"4\"},\"on_behalf_of\":null,\"order\":null,\"outcome\":{\"advice_code\":null,\"network_advice_code\":null,\"network_decline_code\":null,\"network_status\":\"approved_by_network\",\"reason\":null,\"risk_level\":\"normal\",\"risk_score\":37,\"seller_message\":\"Payment complete.\",\"type\":\"authorized\"},\"paid\":true,\"payment_intent\":null,\"payment_method\":\"card_1QnSEfBJNvSBJ4pqBoPhQf5J\",\"payment_method_details\":{\"card\":{\"amount_authorized\":791,\"authorization_code\":null,\"brand\":\"visa\",\"checks\":{\"address_line1_check\":null,\"address_postal_code_check\":\"pass\",\"cvc_check\":\"pass\"},\"country\":\"US\",\"exp_month\":11,\"exp_year\":2026,\"extended_authorization\":{\"status\":\"disabled\"},\"fingerprint\":\"vyyRo4mydWmFhJ6x\",\"funding\":\"credit\",\"incremental_authorization\":{\"status\":\"unavailable\"},\"installments\":null,\"last4\":\"1111\",\"mandate\":null,\"multicapture\":{\"status\":\"unavailable\"},\"network\":\"visa\",\"network_token\":{\"used\":false},\"network_transaction_id\":\"118121121821115\",\"overcapture\":{\"maximum_amount_capturable\":791,\"status\":\"unavailable\"},\"regulated_status\":\"unregulated\",\"three_d_secure\":null,\"wallet\":null},\"type\":\"card\"},\"receipt_email\":null,\"receipt_number\":null,\"receipt_url\":\"https:\\/\\/pay.stripe.com\\/receipts\\/payment\\/CAcaFwoVYWNjdF8xTGVISFpCSk52U0JKNHBxKJyP9bwGMgbrt5zF7Nc6LBaLQU9ZqyuLqIYhNW7S72bUUA_XCYKULvkpxVnWE3u5kNczUJyN7tsNcbW-\",\"refunded\":false,\"review\":null,\"shipping\":null,\"source\":{\"id\":\"card_1QnSEfBJNvSBJ4pqBoPhQf5J\",\"object\":\"card\",\"address_city\":null,\"address_country\":null,\"address_line1\":null,\"address_line1_check\":null,\"address_line2\":null,\"address_state\":null,\"address_zip\":\"10001\",\"address_zip_check\":\"pass\",\"allow_redisplay\":\"unspecified\",\"brand\":\"Visa\",\"country\":\"US\",\"customer\":null,\"cvc_check\":\"pass\",\"dynamic_last4\":null,\"exp_month\":11,\"exp_year\":2026,\"fingerprint\":\"vyyRo4mydWmFhJ6x\",\"funding\":\"credit\",\"last4\":\"1111\",\"metadata\":[],\"name\":null,\"regulated_status\":\"unregulated\",\"tokenization_method\":null,\"wallet\":null},\"source_transfer\":null,\"statement_descriptor\":null,\"statement_descriptor_suffix\":null,\"status\":\"succeeded\",\"transfer_data\":null,\"transfer_group\":null}', 'STRIPE', 0, NULL, '2025-01-31 21:58:38', '2025-01-31 21:58:57');
