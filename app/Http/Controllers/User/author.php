<form id="luluOrderForm" enctype="multipart/form-data">
    ...
    <label>Phone: <input type="tel" name="phone" pattern="\+?\d{10,15}" placeholder="+1234567890" required></label><br>
    ...
    <label>Postcode: <input type="text" name="postcode" pattern="\d{5}" placeholder="12345" required></label><br>
    <label>Country Code (ISO 2-letter): <input type="text" name="country" pattern="[A-Z]{2}" placeholder="US" required></label><br>
