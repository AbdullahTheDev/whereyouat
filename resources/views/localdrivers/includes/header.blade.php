            ...
            <li class="nav-item nav-profile dropdown">
                <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown"
                    ...
                    <div class="nav-profile-img">
                        <img src="{{ Auth::user()->localDriver->profile_photo ? asset('drivers_profile/' . Auth::user()->localDriver->profile_photo) : asset('users_profile/default-profile.png') }}" alt="image">
