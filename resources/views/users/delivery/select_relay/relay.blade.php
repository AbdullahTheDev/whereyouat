            ...
            <div class="container">
                <ul class="nav nav-tabs" id="relayTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="arrival-tab" data-bs-toggle="tab" data-bs-target="#arrival"
                            type="button" role="tab" aria-controls="arrival" aria-selected="true">
                            Arrival City Relay Points
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="departure-tab" data-bs-toggle="tab" data-bs-target="#departure"
                            type="button" role="tab" aria-controls="departure" aria-selected="false">
                            Departure City Relay Points
                        </button>
                    </li>
                </ul>
                <div class="tab-content" id="relayTabsContent">
                    <!-- Arrival City Relay Points Tab -->
                    <div class="tab-pane fade show active" id="arrival" role="tabpanel" aria-labelledby="arrival-tab">
                        <div class="row mt-3">
                            @foreach ($relays as $relay)
                                <div class="col-md-6 mb-4">
                                    <div class="card shadow-sm position-relative">
                                        @if ($relay->user->role == 'partner_home')
                                            <span
                                                class="badge bg-primary position-absolute top-0 start-50 translate-middle px-3 py-2 shadow-sm rounded-pill">Partner
                                                Home</span>
                                        @else
                                            <span
                                                class="badge bg-success position-absolute top-0 start-50 translate-middle px-3 py-2 shadow-sm rounded-pill">Commercial
                                                Place</span>
                                        @endif
                                        <div class="card-body">
                                            <h4 class="card-title">
                                            ...
                                            @if ($relay->user->role == 'partner_home')
                                                <div class="modal fade" id="businessInfoModal-{{ $relay->id }}"
                                                    tabindex="-1"
                                                    aria-labelledby="businessInfoModalLabel-{{ $relay->id }}"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <p><strong>House Address:</strong>
                                                                    {{ $relay->home_address }}</p>
                                                                <hr>
                                                                ...
                                                                @if ($relay->manager != null)
                                                                    ...
                                                                    <p><strong>Name:</strong> {{ $coOwner['name'] ?? '' }}
                                                                    </p>
                                                ...
                                                <div class="modal fade" id="businessInfoModal-{{ $relay->id }}"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="businessInfoModalLabel-{{ $relay->id }}">
                                                                    Business
                                                                    Information</h5>
                                                                <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal" aria-label="Close"></button>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <p><strong>Address:</strong>
                                                                    {{ $relay->responsible_address }}</p>
                                                                <hr>
                                                                <h6>Business Info</h6>
                                                                <p><strong>Trade Name:</strong> {{ $relay->trade_name }}
                                                                </p>

                                                                <p><strong>Email:</strong> {{ $relay->business_email }}</p>
                                                                <p><strong>Phone:</strong> {{ $relay->business_phone }}</p>
                                                                <p><strong>Address:</strong> {{ $relay->business_address }}
                                                                </p>
                                ...
                                <div class="modal fade" id="confirmModal-{{ $relay->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form method="POST"
                                                    action="{{ route('user.delivery.distance.partner.post') }}">
                                                    @csrf
                    ...
                    <div class="tab-pane fade" id="departure" role="tabpanel" aria-labelledby="departure-tab">
                        <div class="row mt-3">
                            @foreach ($departureRelays as $relay)
                                <div class="col-md-6 mb-4">
                                    <div class="card shadow-sm position-relative">
                                        @if ($relay->user->role == 'partner_home')
                                            <span
                                                ...
                                                <div class="modal fade" id="businessInfoModal-{{ $relay->id }}"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <h6>Business Information</h6>
                                                                <p><strong>House Name:</strong> {{ $relay->home_name }}
                                                                </p>
                                                                <p><strong>House Address:</strong>
                                                                    {{ $relay->home_address }}
                                                                </p>
                                                                ...
                                                                <h6>Manager Information</h6>
                                                                <p><strong>Name:</strong> {{ $relay->user->name }}</p>
                                                                <p><strong>Email:</strong> {{ $relay->user->email }}
                                                                </p>
                                                                <p><strong>Phone:</strong> {{ $relay->user->phone }}
                                                                </p>
                                                                <p><strong>Date Of Birth:</strong>
                                                                    {{ $relay->user->date_of_birth }}</p>
                                                                <hr>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <p><strong>Email:</strong> {{ $relay->business_email }}
                                                                </p>
                                                                <p><strong>Phone:</strong> {{ $relay->business_phone }}
                                                                </p>
                                                                <p><strong>Address:</strong>
                                                                    {{ $relay->business_address }}</p>
                                                                <p><strong>Business Number:</strong>
                                                                    {{ $relay->business_number }}</p>
                                                                <hr>
                                                                @if ($relay->co_manager_details != null)
                                ...
                                <div class="modal fade" id="confirmDepartureModal-{{ $relay->id }}"
                                    tabindex="-1" aria-labelledby="confirmDepartureModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="confirmDepartureModalLabel">Confirm
                                                    Selection</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
