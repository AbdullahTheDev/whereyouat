        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">All Direct Deliveries</h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($delivery->accepted == 1 || $delivery->status == 2)
                                                    ...
                                                    @else
                                                        <a class="btn btn-sm btn-primary"
                                                            href="{{ route('user.delivery.distance.driver', $delivery->id) }}">View</a>
                                                    @endif
                                                @else
                                                    - -
                                                @endif
                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">All Partner Deliveries</h4>
                            <table class="table table-bordered" id="myTablePartner">
                                <thead>
                                    <tr>
                                        <th> # </th>
                                        <th> Transaction Date </th>
                                ...
                                <tbody>
                                    @foreach ($deliveriesPartners as $key => $delivery)
                                        <tr>
                                            <td> {{ $key + 1 }} </td>
                                            <td> {{ $delivery->transaction_date }} </td>
                                            <td>
                                            ...
                                            <td>
                                                @if ($delivery->accepted == 1 || $delivery->status == 2)
                                                    <a class="btn btn-sm btn-primary"
                                                        href="{{ route('user.delivery.distance.local.driver', $delivery->id) }}">View</a>
                                                @else
                                                    - -
                                                @endif
                                            </td>
...
@section('script')
    <script>
        ...
        let tablePartner = new DataTable('#myTablePartner');
    </script>
@endsection
